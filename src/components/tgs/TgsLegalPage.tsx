    ...
    <div>
      ...
      >
        <div className="drawer-header">
          ...
          <button className="drawer-close" onClick={() => setDrawerOpen(false)} aria-label="Close menu" type="button">&times;</button>
        </div>
        ...
        <div className="drawer-body">
          <div className="drawer-group">
            ...
            <Link href="/global-santcum/retreat-venues" className="drawer-link">Retreat Venues<span className="drawer-link-arrow">&rarr;</span></Link>
            <Link href="/global-santcum/wellness-venues" className="drawer-link">Wellness Venues<span className="drawer-link-arrow">&rarr;</span></Link>
            <Link href="/global-santcum/wellness-experiences" className="drawer-link">Wellness Experiences<span className="drawer-link-arrow">&rarr;</span></Link>
          </div>
          <div className="drawer-group">
        ...
        <div className="drawer-footer">
          <div className="drawer-footer-contact">
            <a className="email-link drawer-footer-item" href={`mailto:${EMAIL}`}>
