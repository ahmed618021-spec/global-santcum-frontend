...
.nav.scrolled { box-shadow: 0 2px 20px rgba(49, 49, 49, 0.06); }
...
.nav-drawer-close:hover { color: var(--canyon-clay); }
...
.nav-drawer-links a:hover { color: var(--canyon-clay); padding-left: 8px; }

.nav-drawer-section-label {
  font-family: var(--font-sans); font-size: 9px; font-weight: 500;
  letter-spacing: 0.22em; text-transform: uppercase;
  color: var(--charcoal-50); margin: 28px 0 8px;
}
...
.nav-drawer-footer a:hover { border-color: var(--canyon-clay); }
...
.error-suggestions a:hover { border-color: var(--charcoal); }
...
.footer-logo-placeholder {
  ...
  border: 2px dashed var(--gold-accent); border-radius: 10px;
  display: flex; align-items: center; justify-content: center;
...
.footer-links a {
  ...
  color: rgba(255, 255, 255, 0.6); transition: color 0.3s ease;
}
...
@media (max-width: 768px) {
  ...
  .nav-logo-placeholder { width: 36px; height: 36px; }
  .nav-book-now { font-size: 9px; padding: 9px 16px; }
  .nav-drawer { width: 100%; max-width: 100vw; }

  .error-section { padding: 140px 24px 80px; }
  .error-actions { flex-direction: column; }
  .error-suggestions { flex-direction: column; gap: 16px; }
...
.error-inner > *:nth-child(1) { animation-delay: 0.1s; }
.error-inner > *:nth-child(2) { animation-delay: 0.2s; }
.error-inner > *:nth-child(3) { animation-delay: 0.3s; }
.error-inner > *:nth-child(4) { animation-delay: 0.4s; }
.error-inner > *:nth-child(5) { animation-delay: 0.5s; }
.error-inner > *:nth-child(6) { animation-delay: 0.6s; }
.error-inner > *:nth-child(7) { animation-delay: 0.7s; }
`;
...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      ["Experiences", "/global-santcum/wellness-experiences"],
    ],
  },
  {
...
export default function TgsNotFoundPage() {
  ...
  return (
    <div className="tgs-not-found-shell">
      ...
      <section className="error-section">
        <div className="error-inner">
          ...
          <h1 className="error-title">This Path Leads Elsewhere</h1>
          <p className="error-text">
            The page you&apos;re looking for may have moved, been renamed, or is
            temporarily unavailable. Let us guide you back to where you need to
            be.
          </p>
          <div className="error-actions">
            <Link href="/global-santcum/web" className="error-btn-primary">
              Return Home
            </Link>
            <Link href="/global-santcum/contact" className="error-btn-secondary">
              Contact Us
            </Link>
          </div>
          <div className="error-divider" />
          <p className="error-suggestions-label">Or explore</p>
          <div className="error-suggestions">
            ...
            <Link href="/global-santcum/wellness-experiences">Experiences</Link>
      ...
      <footer className="footer">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p className="footer-brand-text">
              ...
              facilitators, travelers, and seekers worldwide.
            </p>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; 2026 The Global Sanctum. All rights reserved.
          </p>
          <div className="footer-legal">
            <Link href="/global-santcum/terms-and-conditions">Terms</Link>
            <Link href="/global-santcum/privacy-policy">Privacy</Link>
            <Link href="/global-santcum/cookies-policy">Cookies</Link>
          </div>
        </div>
      </footer>
    </div>
